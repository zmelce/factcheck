...
def extract_observalgerie(html: str) -> Tuple[str, str]:
    ...
    for comp_div in container.find_all("div", class_="component"):
        for sib in list(comp_div.find_next_siblings()):
...
def fetch_and_extract(url: str, timeout: int = 30) -> dict:
    ...
    title, body = extract_observalgerie(html)
